// ==UserScript==
// @name         Funbox 結帳自動設定（配合戰鬥陀螺監控儀表板）
// @namespace    funbox-tools.local
// @version      1.2
// @description  在 funbox 購物車/結帳頁自動按「立即結帳」、選好超商取貨＋付款方式＋電子發票，把流程推到只剩最後一顆送出訂單由你本人按。信用卡卡號一律不碰（在 CYBERBIZ 的獨立 iframe 內）；若帳號已存卡片則自動幫你選那張。
// @match        https://shop.funbox.com.tw/products/*
// @match        https://shop.funbox.com.tw/cart*
// @match        https://shop.funbox.com.tw/carts/*
